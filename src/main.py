...
def main(args):
    ...
    df_p1a1 = df_p1a1.astype(args['pandas_schema_p1a1'])

    # Generate p2a1
    df_p2a1 = calculate(df_p1a1, args)
    ...
    pandas_schema_p2a1 = args['pandas_schema_p1a1'] | {
    ...
    output(pl.from_pandas(df_p2a1.astype(pandas_schema_p2a1)).sort(by = ['HarvestYear', 'ID2']), 2, 1, args)
